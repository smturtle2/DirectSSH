...
The debug APK is installable for local testing. The release APK generated by the current build is unsigned and should be signed before distribution outside development workflows.
